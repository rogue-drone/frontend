...
<template>
  ...
  <div
      class="navbar shadow-lg bg-neutral-focus text-neutral-content lg:rounded-box col-span-1 md:col-span-3 lg:col-span-4">
    ...
    <div class="flex-1 px-2 mx-2">
      <div class="items-stretch" v-if="activeGuild !== null">
    ...
    <div class="flex-none" v-if="isLoaded">
      <div class="dropdown dropdown-end">
        ...
        <ul tabindex="1" class="shadow menu dropdown-content bg-base-100 text-neutral rounded-box" v-if="!activeGuild">
          ...
          <li class="divider h-1 m-0" v-if="guildList.length > 0"></li>
          <li>
            <a @click="connectBot">
              <IconLink class="mr-2 w-4 h-4"/>
              Connect bot
            </a>
          </li>
        </ul>
    ...
    <div class="flex-none" v-else>
      <div class="dropdown dropdown-end" v-if="isLoaded && user">
        <div tabindex="0" class="btn btn-ghost rounded-btn align-middle">
          ...
          <div class="hidden lg:block">{{ user.username }}
            <div class="text-neutral inline-block">#{{ user.discriminator }}</div>
          </div>
